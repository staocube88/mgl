...
$amount USD Successfully Added TO $username ! <br>
...
////------------------------------>>>>>>>>>ADD_BAL
mysql_query("INSERT INTO add_bal SET usid='".$midOfUsername[0]."', trx='".$txn_id."', tm='".time()."', amount='".$amount."', method='ADMIN', status='1'");
////------------------------------>>>>>>>>>ADD_BAL
