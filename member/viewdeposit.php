...
<h1>Deposit  <span class="shop-green">History</span></h1>
</div><!--/end container-->
</div>
<!--=== End Breadcrumbs v4 ===-->
...
$i = 1;
$ddaa = mysql_query("SELECT deposit_amount, bidtm, pay FROM deposit WHERE mid='".$uid."' ORDER BY id");
echo mysql_error();
